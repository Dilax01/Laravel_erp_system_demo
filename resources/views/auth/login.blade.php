      ...
      <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="shadow-soft border-light p-lg-5 w-100 fmxw-500 rounded border bg-white p-4">
          <div class="text-md-center mt-md-0 mb-4 text-center">
            ...
            <p class="mb-0">Email: <strong>admin@test.com</strong> Password: <strong>password</strong></p>
            <div class="my-3 text-center">
              <span class="fw-normal">or login with</span>
            </div>
            <button class="btn btn-gray-700" id="getRandomEmp">Get Random Employee</button>
          </div>
          ...
          <form action="{{ route('login') }}" method="POST">
            ...
            @if (session()->has('login'))
              <div class="invalid-feedback text-center">{{ session()->get('login') }}</div>
            @endif
            ...
            <div class="form-group mb-4">
              ...
              <div class="input-group">
                ...
                <span class="input-group-text" onclick="togglePassword()" style="cursor: pointer;">👁️</span>
              </div>
              @error('password')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              <div class="form-check">
                <input wire:model="remember_me" class="form-check-input" type="checkbox" id="remember">
                <label class="form-check-label mb-0" for="remember">Remember me</label>
              </div>
              <a href="{{ route('forgot-password') }}" class="text-primary text-decoration-underline">
